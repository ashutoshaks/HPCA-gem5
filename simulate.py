...
result_dir = os.path.expanduser('~/gem5/configs/assignment/results')
if not os.path.exists(result_dir):
    os.makedirs(result_dir)

# The log file helps to identify which simulations have been completed
log_file = os.path.expanduser('~/gem5/configs/assignment/simulate.log')
...
for param in param_combinations:
    ...
    # Run the simulation
    cmd = f'''~/gem5/build/X86/gem5.opt \
            --outdir={result_dir}/{outdir} \
            ~/gem5/configs/assignment/config.py \
            -b ~/gem5/configs/assignment/qsort3 \
            --LQEntries={param[0]} \
            --SQEntries={param[1]} \
            --l1d_size={param[2]} \
            --l1i_size={param[3]} \
